function authorizationTemplate(){
	$.get('/Calendar-Generator/templates/authorization-template.mst',function(template){
...
function generationTemplate(){
	...
	$.get('/Calendar-Generator/templates/creation-template.mst', function(template){
		var rend = Mustache.render(template);
...
function terminateTemplate(){
	$('.calendar-creation').empty();
	$.get('/Calendar-Generator/templates/terminate-template.mst', function(template){
		var rend = Mustache.render(template);
